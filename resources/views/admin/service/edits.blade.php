            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                        <input type="text" name="price" id="price" value="{{"Rp. " .number_format($da->price, 0, ",", ".")}}" class="form-control" id="inputText">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">                            
                            <select class="form-control select-field"  id="ser" name="ser" data-placeholder="Choose one thing"  required>
                            <option></option>
                            @foreach($ser as $row)                                
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">                            
                            <select class="form-control select-field" data-placeholder="Pilih Layanan" id="lay" name="lay" required>   
                                <option></option>          
                                @foreach($lay as $row)
